...
export default function RegisterModal() {
    return (
        <div className="w-[40vw] max-h-[90vh] overflow-y-auto bg-white shadow-2xl shadow-blue-300 rounded-xl flex flex-col items-center py-8 px-6">
            <div className="w-full flex flex-col items-center">
                ...
                <form action="" className="mt-10 flex flex-col gap-4">
                    ...
                    <p className="text-black/70 text-sm mb-2">
                        Don't have an account? <Link href="/register" className="text-lg text-blue-500 font-bold">Log in</Link>
                    </p>
                </form>
